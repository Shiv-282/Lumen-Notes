...
## 🐧 F-Droid
Lumen is built to be F-Droid-friendly: fully offline, no trackers, no non-free dependencies, GPL-3.0 licensed, and buildable from source with plain Gradle. An inclusion request to the F-Droid community is planned — the ready-to-use build recipe lives in [`fdroid/com.lumen.notes.yml`](fdroid/com.lumen.notes.yml).

## 📄 License
Licensed under the **GNU GPL-3.0** — see [LICENSE](LICENSE). You are free to use, study, modify, and share the app.
